...
const UserDetails = () => {
    ...
    // New variables to handle optional sections
    const isProfessional = user.userType && (user.userType.includes('agent') || user.userType.includes('developer'));
    const hasProfessionalDetails = isProfessional && (user.companyName || user.licenseNumber || user.experience || (user.specialization && user.specialization.length > 0));
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-8">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Professional Details (Conditional and Dynamic) */}
